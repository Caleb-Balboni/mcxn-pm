...
#define WUU_INTERRUPT_IRQ 147 // WUU interrupt number 
// TODO --> module interrupt numbers need to be added
...
struct external_pin_cfg {
  ...
  wuu_cb_t cb;      // user callback function upon pin activation
  void* user_data;  // user data passed to callback function
};
...
// @param pin - the external pin which will act as the wake up source (0 - 31)
